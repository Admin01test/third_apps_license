...
class SaleEstimatelineJob(models.Model):
    ...
    def _get_display_price(self, product):
        ...
        price, rule_id = self.estimate_id.pricelist_id.with_context(product_context).get_product_price_rule(product or self.product_id, self.product_uom_qty or 1.0, self.estimate_id.partner_id)
    ...
    def product_id_change(self):
        ...
        # https://github.com/odoo/odoo/commit/86febae278f08864e83017d43f6aa9d67165d664#diff-10b2bbc33d35a6945f223d38901a2de33fffe78db172d3b939edf0b65aa48c05L1719
        ...
        if rule_id:
            ...
            if pricelist_item.pricelist_id.discount_policy == 'without_discount':
                while pricelist_item.base == 'pricelist' and pricelist_item.base_pricelist_id and pricelist_item.base_pricelist_id.discount_policy == 'without_discount':
                    price, rule_id = pricelist_item.base_pricelist_id.with_context(uom=uom.id).get_product_price_rule(product, qty, self.estimate_id.partner_id)
                    pricelist_item = PricelistItem.browse(rule_id)
